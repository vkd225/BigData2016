...
def main():
    ...
    for values in parseInput():
        ...
        try:
            ...
            passenger_count = values[6]
            pickup_longitude = values[9]
            pickup_latitude = values[10]
            dropoff_longitude = values[11]
            dropoff_latitude = values[12]
            tip_amount = values[17]
            total_amount = values[19]
            paymentType = data[13]
